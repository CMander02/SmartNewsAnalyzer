"""Used for assisting db queries from public API"""
# Library imports
import cProfile
import pstats
import logging
...
def connect_to_db():
    ...
    database_ip = config('databaseIP', default='')
    try:
...
def db_connector_profiler():
    ...
    profiler.enable()
    query_db("INSERT INTO DOCUMENTS (documentID,userID,docName,docType) VALUES (4525, 074, 'Test.pdf', '.pdf')")
