...
-- Table: Documents
CREATE TABLE IF NOT EXISTS Documents (documentID INTEGER PRIMARY KEY AUTOINCREMENT, UserID INTEGER REFERENCES Users (UserID) ON UPDATE SET DEFAULT, DocType TEXT, Summary TEXT, PagesNum INTEGER, StanzaNum INTEGER);
